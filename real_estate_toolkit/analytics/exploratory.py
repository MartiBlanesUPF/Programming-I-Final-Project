...
class MarketAnalyzer:
    ...
    def generate_price_distribution_analysis(self) -> pl.DataFrame:
        ...
        try:
            ...
            os.makedirs("src/real_estate_toolkit/analytics/outputs/", exist_ok=True)
    ...
    def feature_correlation_heatmap(self, variables: List[str]) -> None:
        ...
        try:
            ...
            os.makedirs("src/real_estate_toolkit/analytics/outputs/", exist_ok=True)
            fig.write_html("src/real_estate_toolkit/analytics/outputs/feature_correlation_heatmap.html")
        except Exception as e:
    ...
    def create_scatter_plots(self) -> Dict[str, go.Figure]:
        ...
        try:
            ...
            fig1.write_html("src/real_estate_toolkit/analytics/outputs/house_price_vs_square_footage.html")
            ...
            fig2.write_html("src/real_estate_toolkit/analytics/outputs/sale_price_vs_year_built.html")
            ...
            fig3.write_html("src/real_estate_toolkit/analytics/outputs/overall_quality_vs_sale_price.html")
