...
class Simulation:
    ...
    def create_housing_market(self):
      ...
      for house_data in self.housing_market_data:
          ...
          # Add type checks or other validation if needed
          # ...
      ...
      for consumer_data in self.consumers_data:
          ...
          # Create Consumer object based on consumer_data
          consumer = Consumer(
              consumer_data["id"],
      ...
      self.consumers = consumers # Assign the consumers to the class.
